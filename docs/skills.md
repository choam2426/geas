...
`specifying`은 User 목표를 Mission Spec, Mission Design, 초기 Task Contract로 이어지는 검토 가능한 기준선으로 만든다.
...
5. User가 Mission Design을 수용하면 초기 Task Contract 후보를 만들고 User review로 올린다.
6. User가 수용한 기준선만 runtime에 기록한다.
