...
이 단계에서 agent는 Task contract를 바탕으로 더 세밀한 execution plan을 세운 뒤 작업하고, Implementation Evidence, verification, review를 거쳐 Task별 Evidence를 남긴다. 필요한 경우 다음 Task contract를 구체화하거나 갱신한다.
