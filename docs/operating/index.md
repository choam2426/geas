...
Task 추가, 삭제, 기본 진행 순서, dependency, Mission coverage가 바뀌면 Mission design을 갱신한다. Task의 실행 범위, 산출물, 수용 기준, verification checks, review focus, 위험 수준이 바뀌면 Task contract를 갱신한다.
