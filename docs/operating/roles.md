...
|역할|핵심 책임|
|---|---|
|Work Designer|Mission design의 진행 계획을 설계하거나, Task Contract 단계에서 Task 분리 구조와 의존 관계를 설계한다. 두 산출물의 책임을 섞지 않는다.|
...
- Mission spec을 바탕으로 Mission design의 접근, 핵심 개념, scope, 계획 outline, 판단 지점을 작성한다.
- Mission spec과 Mission design을 바탕으로 초기 Task contract를 작성한다.
- Task contract에서 Mission을 어떤 Task 구조로 나눌지와 그 이유를 남긴다.
- Task contract에서 Task 의존 관계를 설계한다.
