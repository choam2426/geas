...
Reviewer는 산출물, Implementation Evidence, Verification Evidence를 검토하고 Review Evidence를 남긴다.

Reviewer는 산출물이 계약 기준과 기대 품질에 비추어 충분한지, 남은 위험이나 재작업할 부분이 있는지 검토한다.

Review Evidence에는 검토 범위, 검토 관점, 사용한 방법, 발견한 문제, 남은 위험, 제외한 범위, 권고가 들어간다.
