...
Mission Design과 Task Contract 작성은 Orchestrator와 `specifying` 흐름의 책임이며, 별도 Agent reference로 분리하지 않는다.
...
- 위 4개 Agent reference 파일이 `skills/mission/references/agents/`에 존재한다.
