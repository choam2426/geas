...
설정: `plugins/geas/hooks/hooks.json`
스크립트: `plugins/geas/hooks/scripts/`
공용 헬퍼: `plugins/geas/hooks/scripts/lib/geas-hooks.js`
...
- `plugins/geas/hooks/hooks.json` — 현재 등록 상태.
- `plugins/geas/hooks/scripts/` — 실제 스크립트 본문.
