...
| [vote-round](#vote-round) | Core - Verification | 불가 | Compass (Genesis 시점) | `.geas/decisions/{dec-id}.json` |
...
| [write-prd](#write-prd) | Team - Planning | 불가 | Nova (Genesis 중) | `.geas/spec/prd.md` |
| [write-stories](#write-stories) | Team - Planning | 불가 | Nova (Genesis 중) | `.geas/spec/stories.md` |
...
**호출 주체:** Compass — Initiative (Genesis 1.6단계)와 Sprint (1단계)
...
**호출 주체:** Compass — 주요 아키텍처 또는 횡단 관심사 결정 시 (주로 Genesis 1.5단계)
...
Geas 팀으로 새 제품을 만듭니다. Genesis, MVP Build, Polish, Evolution 4개 단계입니다.
...
**핵심 동작:**
- Genesis를 완전히 건너뜁니다. PRD, stories, 아키텍처 투표 없습니다. 기능 설명에서 바로 TaskContract 하나를 컴파일합니다.
...
**호출 주체:** Nova — Genesis (Initiative 1.3단계)
...
**호출 주체:** Nova — Genesis (Initiative 1.3단계), write-prd 직후
