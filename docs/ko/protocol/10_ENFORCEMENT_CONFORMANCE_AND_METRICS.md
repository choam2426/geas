...
| polishing → evolving | `evolution/gap-assessment-polishing.json` 및 `evolution/debt-register.json` 존재, blocked/escalated task 없음 |
| evolving → complete | `evolution/gap-assessment-evolving.json` 및 `mission-summary.md` 존재 |
