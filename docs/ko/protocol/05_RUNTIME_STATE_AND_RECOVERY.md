...
| `active_tasks` | `implementing` / `reviewed` / `verified` 중 하나인 task ID 목록. 즉 아직 passed/cancelled/escalated로 종결되지 않았고 blocked로 멈추지도 않은 "진행 중 open work" (0개: idle, 1개: sequential, N개: parallel batch) |
