...
3. [Debate (유틸리티 스킬)](#debate-유틸리티-스킬)
...
Debate는 실행 모드가 아닌 유틸리티 스킬이다. `/geas:debate`로 독립 실행하거나, Initiative/Sprint 중 구조적 결정이 필요할 때(예: vote round 의견 불일치 시) 내부적으로 호출할 수 있다.
