...
| 문서 | 설명 |
|------|------|
| [사용 가이드](docs/GUIDE.md) | 설치, 첫 미션, 모드별 사용법, .geas/ 구조, FAQ |
| [거버넌스](docs/GOVERNANCE.md) | 투표, 토론, Critic 역할, 에스컬레이션 경로 |
| [에이전트 레퍼런스](docs/AGENTS.md) | 12개 전문 에이전트 — 역할, 그룹, 증거, MCP 도구 |
| [스킬 레퍼런스](docs/SKILLS.md) | 24개 스킬 — 계약 엔진, 프로토콜, 유틸리티 |
| [훅 레퍼런스](docs/HOOKS.md) | 4개 훅 — 파이프라인 규칙의 기계적 강제 |
