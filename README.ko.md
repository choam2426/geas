...
**칸반 보드** — task가 9단계 lifecycle 컬럼(drafted → ready → implementing → reviewed → verified → passed, 측면 상태 blocked / escalated / cancelled)을 따라 이동합니다. 카드를 클릭하면 contract, evidence, closure 섹션을 확인할 수 있습니다.
