...
- Required Pre-build Design Surface decisions are resolved, reflected in Mission Design or the Task Contract Set, or explicitly accepted by the User as non-blocking.
